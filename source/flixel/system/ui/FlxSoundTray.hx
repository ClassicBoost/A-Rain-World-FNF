...
class FlxSoundTray extends Sprite
{
	...
	public function new()
	{
		...
		#else
		#end
		var dtf:TextFormat = new TextFormat(Paths.font("rw-menu.ttf"), 8, 0xffffff);
	...
	public function update(MS:Float):Void
	{
		...
		text.defaultTextFormat = new TextFormat(Paths.font("rw-menu.ttf"), 8, 0xffffff);
	}
	...
	public function show(up:Bool = false):Void
	{
		...
		if (globalVolume >= 10)
			sound = Paths.sound('menus/base/cancelMenu');
