...
class OptionsMenuState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		infoText = new FlxText(5, FlxG.height - 32, 0, "", 32);
		infoText.setFormat(Paths.font("rw-menu.ttf"), 20, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
