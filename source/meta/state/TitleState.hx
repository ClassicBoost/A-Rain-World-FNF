...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			FlxG.sound.playMusic(Paths.music('rain'), 0.7);
		}
		...
		rainLolllll.frames = Paths.getSparrowAtlas('menus/base/title/rain');
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 6:
				addMoreText('Classic');
				addMoreText('Cehroaza');
			case 8:
				deleteCoolText();
			case 9:
				createCoolText(['Rain World By']);
			case 10:
				addMoreText('');
				ngSpr.visible = true;
			case 12:
