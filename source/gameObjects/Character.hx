...
class Character extends FNFSprite
{
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		var fileTo:String = 'characters/sprites/';

		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('${fileTo}GF_assets');
				frames = tex;
			...
			case 'gf-christmas':
				tex = Paths.getSparrowAtlas('${fileTo}gfChristmas');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gf-car':
				tex = Paths.getSparrowAtlas('${fileTo}gfCar');
				frames = tex;
			...
			case 'gf-pixel':
				tex = Paths.getSparrowAtlas('${fileTo}gfPixel');
				frames = tex;
			...
			case 'gf-tankmen':
				frames = Paths.getSparrowAtlas('${fileTo}gfTankmen');
			...
			case 'dad':
				...
				tex = Paths.getSparrowAtlas('${fileTo}DADDY_DEAREST');
				frames = tex;
				...
				playAnim('idle');
			case 'spooky':
				tex = Paths.getSparrowAtlas('${fileTo}spooky_kids_assets');
				frames = tex;
				...
				playAnim('danceRight');
			case 'mom':
				tex = Paths.getSparrowAtlas('${fileTo}Mom_Assets');
				frames = tex;
			...
			case 'mom-car':
				tex = Paths.getSparrowAtlas('${fileTo}momCar');
				frames = tex;
				...
				playAnim('idle');
			case 'monster':
				tex = Paths.getSparrowAtlas('${fileTo}Monster_Assets');
				frames = tex;
			...
			case 'monster-christmas':
				tex = Paths.getSparrowAtlas('${fileTo}monsterChristmas');
				frames = tex;
				animation.addByPrefix('idle', 'monster idle', 24, false);
				animation.addByPrefix('singUP', 'monster up note', 24, false);
				animation.addByPrefix('singDOWN', 'monster down', 24, false);
				...
				playAnim('idle');
			case 'pico':
				tex = Paths.getSparrowAtlas('${fileTo}Pico_FNF_assetss');
				frames = tex;
			...
			case 'bf','slugcat':
				frames = Paths.getSparrowAtlas('${fileTo}BOYFRIEND');
			...
			/*
				case 'bf-og':
					frames = Paths.getSparrowAtlas('${fileTo}og/BOYFRIEND');
			...
			case 'bf-dead':
				frames = Paths.getSparrowAtlas('${fileTo}BF_DEATH');
			...
			case 'bf-holding-gf':
				frames = Paths.getSparrowAtlas('${fileTo}bfAndGF');
			...
			case 'bf-holding-gf-dead':
				frames = Paths.getSparrowAtlas('${fileTo}bfHoldingGF-DEAD');
			...
			case 'bf-christmas':
				var tex = Paths.getSparrowAtlas('${fileTo}bfChristmas');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				flipX = true;
			case 'bf-car':
				var tex = Paths.getSparrowAtlas('${fileTo}bfCar');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				...
				flipX = true;
			case 'bf-pixel':
				frames = Paths.getSparrowAtlas('${fileTo}bfPixel');
				...
				flipX = true;
			case 'bf-pixel-dead':
				frames = Paths.getSparrowAtlas('${fileTo}bfPixelsDEAD');
			...
			case 'senpai':
				frames = Paths.getSparrowAtlas('${fileTo}senpai');
			...
			case 'senpai-angry':
				...
				characterData.camOffsetX = -200;
			case 'spirit':
				frames = Paths.getPackerAtlas('${fileTo}spirit');
			...
			case 'parents-christmas':
				frames = Paths.getSparrowAtlas('${fileTo}mom_dad_christmas_assets');
			...
			default:
				...
				if (OpenFlAssets.exists(Paths.offsetTxt(fileNew)))
				{
					...
					frames = Paths.getSparrowAtlas('${fileTo}$characterName');
