...
class Init extends FlxState
{
	...
	public static var gameSettings:Map<String, Dynamic> = [
		'Lunatic Mode' => [false, Checkmark, 'Requires a certain amount of food pips to live (high accuracy), but being full doubles score.', NOT_FORCED],
		'Downscroll' => [
			false,
			Checkmark,
		...
		'Icons' => [
			'Shown',
			Selector,
			'Static icons will disable animated icons. None hides them entirely.',
			NOT_FORCED,
			['Shown', 'Static', 'None']
		],
