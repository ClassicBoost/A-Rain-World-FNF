...
class ClientPrefs {
	...
	public static var showMod:Bool = false;
	...
	public static var lunaticMode:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.lunaticMode = lunaticMode;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.lunaticMode != null) lunaticMode = FlxG.save.data.lunaticMode;
	...
	public static function saveStory(character:String, curSect:Int) {
		switch (character) {
			case 'monk':
				FlxG.save.data.monkStory = curSect;
			case 'survivor':
				FlxG.save.data.survivorStory = curSect;
			case 'hunter':
				FlxG.save.data.hunterStory = curSect;
			case 'inv':
				FlxG.save.data.invStory = curSect;
		}
	}
